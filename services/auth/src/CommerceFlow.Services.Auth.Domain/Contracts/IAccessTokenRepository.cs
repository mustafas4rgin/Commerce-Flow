...
public interface IAccessTokenRepository
{
    ...
    Task<AccessToken?> UpdateAccessTokenAsync(AccessToken token, CancellationToken ct = default);
    Task<AccessToken?> AddAccessTokenAsync(AccessToken token, CancellationToken ct = default);
