...
public interface IRefreshTokenRepository
{
    ...
    Task<RefreshToken?> UpdateRefreshTokenAsync(RefreshToken token, CancellationToken ct = default);
    Task<RefreshToken?> AddRefreshTokenAsync(RefreshToken token, CancellationToken ct = default);
